...
def main():
    ...
    st.markdown('### <span style="font-size:32px;font-weight:bold;">Choose material(s)</span> - <span style="color:grey; font-size:32px;">optional</span>', unsafe_allow_html=True)
