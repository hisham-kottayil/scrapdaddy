...
def main():
    ...
    container_html += f'<div style="margin-left: 20px;"><img src="data:image/png;base64,{home_page_icon_encoded}" alt="Home Page Icon" style="width: 3000px; height: 150px;"></div>'
    container_html += '</div>'
